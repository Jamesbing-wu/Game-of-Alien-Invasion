...
def create_fleet(ai_seetings,screen,aliens,ship):
    alien = Alien(ai_seetings, screen)
    number_aliens_x=get_number_aliens_x(ai_seetings,alien.rect.width)
    number_rows=get_number_rows(ai_seetings,ship.rect.height,alien.rect.height)
    for row_number in range(number_rows):
       for alien_number in range(number_aliens_x):
           creat_alien(ai_seetings, screen, aliens, alien_number,row_number)
...
def creat_alien(ai_seetings,screen,aliens,alien_number,row_number):
    alien = Alien(ai_seetings, screen)
